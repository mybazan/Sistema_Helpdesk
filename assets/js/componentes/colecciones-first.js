(function($){
    ...
    $.initFormCollectionFirst = function(collectionName)
    {
        var $collection = $('[data-collection="'+collectionName+'"]');

        $('[data-collection-add="'+collectionName+'"]').on('click',$(this), function(e) {
            ...
            $('[data-collection]', $newForm).each(function(){        
                $.initFormCollectionFirst($(this).data('collection'));  
            });
